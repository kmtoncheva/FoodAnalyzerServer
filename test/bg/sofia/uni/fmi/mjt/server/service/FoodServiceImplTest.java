...
//
//    @Test
//    void testGetFoodReportWithBrandedFoodItem() throws ApiException {
//        when(httpService.get(anyString())).thenReturn(brandedFoodItem);
...
//
//    @Test
//    void testFoodReportWithFoundationFoodItem() throws ApiException {
//        when(httpService.get(anyString())).thenReturn(foundationFoodItem);
//        ReportFoodItemDto foodItem = foodService.getFoodReport("id");
//
//        Assertions.assertNotNull(foodItem, "Should have parsed correctly.");
...
//
//    @Test
//    void testFoodReportWithSrLegacyFoodItem() throws ApiException {
//        when(httpService.get(anyString())).thenReturn(srLegacyFoodItem);
//        ReportFoodItemDto foodItem = foodService.getFoodReport("id");
//
//        Assertions.assertNotNull(foodItem, "Should have parsed correctly.");
...
//
//    @Test
//    void testFoodReportWithSurveyFoodItem() throws ApiException {
//        when(httpService.get(anyString())).thenReturn(surveyFoodItem);
//        ReportFoodItemDto foodItem = foodService.getFoodReport("id");
//
//        Assertions.assertNotNull(foodItem, "Should have parsed correctly.");
...
//
//    @Test
//    void testFoodReportWithExperimentalFoodItem() throws ApiException {
//        when(httpService.get(anyString())).thenReturn(experimentalFoodItem);
//
...
//    }
//    @Test
//    void testFoodReportWithBadJsonSyntax() throws ApiException {
//        when(httpService.get(anyString())).thenReturn("bad JSON");
//
//        Assertions.assertThrows(MalformedRequestBodyException.class, () -> {
//            foodService.getFoodReport("id");
